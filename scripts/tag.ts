...
if (!version) {
	...
	console.info("Version must be a valid semver version in the format of MAJOR.MINOR.PATCH");
	exit(1);
}
...
console.info("Tags created successfully. Run `git push --tags --force` to push them to the remote.");
